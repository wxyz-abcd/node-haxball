declare namespace MainReturnType {
  ...
  export enum VariableType {
     ...
     * this type is `true` and `false` where `true` means "full" kickoff 
     * reset and `1` means "partial" kickoff reset. Specialized to be edited 
     * with a camera follow selector component inside a GUI environment.
     */
    KickOffReset = 12,
  ...
  export enum CollisionFlags {
    ...
    /**
     * If defined, the object will accept collisions with other "red"s only until the kickoff event happens. 
     */
    redKO = 3,

    /**
     * If defined, the object will accept collisions with other "blue"s only until the kickoff event happens. 
     */
    blueKO = 4,
  ...
  export enum GamePlayState {
     ...
     * but kickoff has not happened yet.
     */
    BeforeKickOff = 0,

    /**
     * This is the state of the game when the game is active and 
     * kickoff has already happened.
     */
    Playing = 1,
  ...
  declare type Stadium = {
    ...
    /**
     * The kickoff circle's radius for the background of this Stadium.
     */
  ...
  declare interface GameCallbacks {
    ...
    /**
     * Called just after a kickoff event has occurred.
     * 
     * @returns void or a custom data to pass to the next callback.
     */
  ...
  declare interface GameRoomConfigCallbacks {
     ...
     * Called just after the game has ended.
     * 
     * @param winningTeamId Id of the team which has won the game.
     * 
     * @returns void or a custom data to pass to the next callback.
     */
  ...
  declare interface APIRoomConfigCallbacks {
     ...
     * 
     * @param addonObject The Addon object that the variable belongs to.
     * @param variableName The name of the variable that value has been changeed.
     * @param oldValue The old value of the variable.
     * @param newValue The new value of the variable.
     * 
     * @returns void or a custom data to pass to the next callback.
  ...
  declare interface CommonRoomConfigCallbacks {
     ...
     * Called just after a team's colors have been changed.
     * 
     * @param teamId The team which colors have been changed.
     * @param value The new team colors value.
     * @param byId Id of the player who has changed the team colors.
     * 
     * @returns void or a custom data to pass to the next callback.
  ...
  export namespace Utils {
     ...
     * the input string is in wrong format.
     * 
     ...
     */
    export function parseStadium(textDataFromHbsFile: string, onError?: ErrorCallback): Stadium|undefined;
  ...
  declare interface UpdateStadiumBgParams {
    ...
    /**
     * The new kickoff radius of the current stadium.
     */
  ...
  declare interface UpdateStadiumGeneralParams {
    ...
    /**
     * The new kickoff reset value of the current stadium. `true`: "full", `false`: "partial"
     */
  ...
  declare interface SandboxModeFunctions {
     ...
     *   - `kickOffRadius: number | null`: The new kickoff radius of the current stadium.
     ...
     *   - `kickOffReset: boolean | null`: The new kickoff reset value of the current stadium. `true`: "full", `false`: "partial"
  ...
  declare interface StartStreamingParams {
    ...
    /**
     * Called when a new visitor starts to watching the stream.
     * 
  ...
  declare interface RoomBase {
    ...
    /**
     * Activate or deactivate the plugin that name is `name`.
     * 
  ...
  class AsyncReplayReader{
     ...
     * @returns void.
     */
    declare setCurrentFrameNo: (destinationFrameNo:number)=>void;
